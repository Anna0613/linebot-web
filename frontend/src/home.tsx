...
// 中優先級 - 認證流程
const ForgetThePassword = lazy(
  () => import("./features/auth/pages/ForgetThePassword")
);
...
const EmailVerificationPending = lazy(
  () => import("./features/auth/pages/EmailVerificationPending")
);
...
const BotManagementPage = lazy(() =>
  import("./features/bot-management/pages/BotManagementPage").then(
    (module) => ({ default: module.default })
  )
);
const UserManagementPage = lazy(() =>
  import("./features/bot-management/pages/UserManagementPage").then(
    (module) => ({ default: module.default })
  )
);
const RichMenuManagementPage = lazy(() =>
  import("./features/rich-menu/pages/RichMenuManagementPage").then(
    (module) => ({ default: module.default })
  )
);

// 最低優先級 - 輔助頁面
const HowToEstablish = lazy(
  () => import("./features/how-to-establish/pages/HowToEstablish")
);
...
const AnimatedRoutes = () => {
  return (
    <Routes>
      ...
      <Route
        path="/bots/management/richmenu"
        element={<RichMenuManagementPage />}
      />
