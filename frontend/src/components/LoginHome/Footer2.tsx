        ...
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] gap-8 sm:gap-12 lg:gap-[120px] mb-8 sm:mb-12">
          ...
          <div className="w-full flex flex-col text-center md:text-left">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/index2" className="text-muted-foreground hover:text-[#0B346E] transition-colors text-sm block py-1">
                  首頁
                </Link>
              </li>
              <li>
                <Link to="/how to establish" className="text-muted-foreground hover:text-[#0B346E] transition-colors text-sm block py-1">
                如何建立LINE Bot
                </Link>
              </li>
              <li>
                <Link to="/add server" className="text-muted-foreground hover:text-[#0B346E] transition-colors text-sm block py-1">
                建立LINE Bot
                </Link>
              </li>
              <li>
                <Link to="/block" className="text-muted-foreground hover:text-[#0B346E] transition-colors text-sm block py-1">
                開始設計LINE Bot
                </Link>
              </li>
              <li>
                <Link to="/editbot" className="text-muted-foreground hover:text-[#0B346E] transition-colors text-sm block py-1">
                管理LINE Bot
                </Link>
              </li>
            </ul>
