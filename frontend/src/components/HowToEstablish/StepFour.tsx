        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <div className="order-1 relative fade-in-element">
            <div className="relative">
              ...
              <div className="absolute -bottom-3 -right-3 sm:-bottom-6 sm:-right-6 w-6 h-6 sm:w-8 sm:h-8 bg-accent/20 rounded-full animate-float" style={{ animationDelay: '1.5s' }}></div>
            </div>
          </div>

          {/* Content Section */}
          <div className="order-2 space-y-6 sm:space-y-8 fade-in-element" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="space-y-6">
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-white/50 shadow-glass">
                <h3 className="text-lg sm:text-xl font-semibold text-foreground mb-4">操作步驟：</h3>
                ...
                <div className="mb-6">
                  ...
                  <ul className="space-y-2 ml-6 sm:ml-7">
                    <li className="flex items-start space-x-3">
                      ...
                      <span className="text-muted-foreground text-xs sm:text-sm">進入 Basic settings 頁面</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <div className="w-5 h-5 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <span className="text-xs font-bold text-primary">2</span>
                      </div>
                      <span className="text-muted-foreground text-xs sm:text-sm">往下滑找到 Channel secret 欄位</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <div className="w-5 h-5 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <span className="text-xs font-bold text-primary">3</span>
                      </div>
                      <span className="text-muted-foreground text-xs sm:text-sm">複製 Channel secret 值</span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2 ml-6 sm:ml-7">
                    <li className="flex items-start space-x-3">
                      ...
                      <span className="text-muted-foreground text-xs sm:text-sm">前往 Messaging API settings 頁面</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <div className="w-5 h-5 rounded-full bg-accent/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <span className="text-xs font-bold text-accent">2</span>
                      </div>
                      <span className="text-muted-foreground text-xs sm:text-sm">找到 Channel access token 區塊</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <div className="w-5 h-5 rounded-full bg-accent/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <span className="text-xs font-bold text-accent">3</span>
                      </div>
                      <span className="text-muted-foreground text-xs sm:text-sm">點擊「Issue」按鈕產生 token</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <div className="w-5 h-5 rounded-full bg-accent/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <span className="text-xs font-bold text-accent">4</span>
                      </div>
                      <span className="text-muted-foreground text-xs sm:text-sm">複製產生的 access token</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-red-50/50 rounded-xl p-4 border border-red-200/50">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-red-900 mb-1 text-sm sm:text-base">重要提醒</h4>
                    <p className="text-xs sm:text-sm text-red-700">請妥善保管這兩個金鑰，不要公開分享。這些是您的 LINE Bot 身份驗證憑證。</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-green-50/50 rounded-xl p-4 border border-green-200/50">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-green-900 mb-1 text-sm sm:text-base">下一步</h4>
                    <p className="text-xs sm:text-sm text-green-700">取得金鑰後，將它們貼到我們的網站中，就可以開始設定您的 LINE Bot 伺服器了。</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <Link to="/add server" className="inline-flex w-full sm:w-auto">
                  <Button size="lg" className="w-full bg-[#F4CD41] hover:bg-[#e6bc00] text-foreground rounded-full shadow-lg hover:shadow-xl transition-all group text-sm sm:text-base">
                    開始設定伺服器
