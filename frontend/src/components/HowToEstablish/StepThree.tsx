        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-white/50 shadow-glass">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start space-x-3">
                    ...
                    <span className="text-muted-foreground text-sm sm:text-base">在Provider頁面中選擇「Channels」</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <div className="w-6 h-6 rounded-full bg-line/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-xs font-bold text-line">2</span>
                    </div>
                    <span className="text-muted-foreground text-sm sm:text-base">點選「Create a Messaging API channel」</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <div className="w-6 h-6 rounded-full bg-line/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-xs font-bold text-line">3</span>
                    </div>
                    <span className="text-muted-foreground text-sm sm:text-base">填寫頻道資訊並選擇地區與類別</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <div className="w-6 h-6 rounded-full bg-line/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-xs font-bold text-line">4</span>
                    </div>
                    <span className="text-muted-foreground text-sm sm:text-base">同意條款並點擊「Create」</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="grid grid-cols-1 gap-4">
                <div className="bg-green-50/50 rounded-xl p-4 border border-green-200/50">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-medium text-green-900 mb-1 text-sm sm:text-base">必填欄位</h4>
                      <p className="text-xs sm:text-sm text-green-700">頻道名稱、描述、地區、應用類別都是必填項目</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-yellow-50/50 rounded-xl p-4 border border-yellow-200/50">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-medium text-yellow-900 mb-1 text-sm sm:text-base">注意事項</h4>
                      <p className="text-xs sm:text-sm text-yellow-700">頻道名稱建立後可以修改，但建議使用易識別的名稱</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="order-1 lg:order-2 relative fade-in-element" style={{ animationDelay: '0.2s' }}>
            <div className="relative">
              ...
              <div className="absolute -bottom-2 -right-2 sm:-bottom-4 sm:-right-4 w-8 h-8 sm:w-12 sm:h-12 bg-primary/20 rounded-full animate-float" style={{ animationDelay: '1s' }}></div>
            </div>
          </div>
        </div>
      </div>
