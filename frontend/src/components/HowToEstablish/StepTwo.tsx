        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <div className="order-1 relative fade-in-element">
            <div className="relative">
              ...
              <div className="absolute -bottom-3 -left-3 sm:-bottom-6 sm:-left-6 w-6 h-6 sm:w-8 sm:h-8 bg-primary/20 rounded-full animate-float" style={{ animationDelay: '1.5s' }}></div>
            </div>
          </div>
            ...
            <div className="space-y-6">
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-white/50 shadow-glass">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start space-x-3">
                    ...
                    <span className="text-muted-foreground text-sm sm:text-base">登入LINE Developers後，點選「Create」按鈕</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <div className="w-6 h-6 rounded-full bg-accent/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-xs font-bold text-accent">2</span>
                    </div>
                    <span className="text-muted-foreground text-sm sm:text-base">輸入Provider名稱（建議使用英文）</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <div className="w-6 h-6 rounded-full bg-accent/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-xs font-bold text-accent">3</span>
                    </div>
                    <span className="text-muted-foreground text-sm sm:text-base">點擊「Create」完成Provider建立</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-blue-50/50 rounded-xl p-4 border border-blue-200/50">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-blue-900 mb-1 text-sm sm:text-base">小提示</h4>
                    <p className="text-xs sm:text-sm text-blue-700">Provider名稱建議使用有意義的英文名稱，之後無法修改。一個開發者可以建立多個Provider來管理不同的專案。</p>
                  </div>
                </div>
              </div>
              
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <Button size="lg" className="w-full sm:w-auto bg-accent hover:bg-accent/90 text-white rounded-full shadow-lg hover:shadow-xl transition-all group text-sm sm:text-base">
