        ...
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] gap-8 sm:gap-12 lg:gap-[120px] mb-8 sm:mb-12">
          ...
          <div className="hidden md:flex w-full flex-col">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-muted-foreground hover:text-[#0B346E] transition-colors text-sm block py-1">
                  首頁
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-muted-foreground hover:text-[#0B346E] transition-colors text-sm block py-1">
                  關於我們
                </Link>
              </li>
              <li>
                <Link to="/login" className="text-muted-foreground hover:text-[#0B346E] transition-colors text-sm block py-1">
                  登入
                </Link>
              </li>
              <li>
                <Link to="/register" className="text-muted-foreground hover:text-[#0B346E] transition-colors text-sm block py-1">
                  註冊
                </Link>
              </li>
            </ul>
