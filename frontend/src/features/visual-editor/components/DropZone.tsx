...
import { UnifiedBlock, UnifiedDropItem, WorkspaceContext, BlockValidationResult } from '@/features/visual-editor/types/block';
import { isBlockCompatible } from '@/features/visual-editor/utils/blockCompatibility';
import { useCompatibilityWorker } from '@/features/visual-editor/hooks/useCompatibilityWorker';
