  ...
  const steps = useMemo(
    () => [
      ...
      },
      {
        id: 2,
        title: "建立 Provider",
        shortTitle: "建立 Provider",
        completed: false,
      },
      {
        id: 3,
        title: "建立 Channel",
        shortTitle: "建立 Channel",
        completed: false,
      },
      {
        id: 4,
            ...
            <div className="max-w-4xl mx-auto mb-8 sm:mb-12">
              <div className="web3-glass-card p-4 sm:p-6 web3-hover-glow border-l-4 border-web3-cyan">
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 space-y-2 sm:space-y-0">
                  <h2 className="neon-text-cyan text-lg sm:text-xl font-bold">
                    教學進度
                  </h2>
                  ...
                  {steps.map((step) => (
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="text-sm">{step.shortTitle}</div>
                      </div>
                      {step.id === currentStep && (
