...
class KnowledgeChunk(Base):
    ...
    # 1536-dim embedding using OpenAI text-embedding-3-small.
    embedding = Column(Vector(1536) if Vector else Text, nullable=True)  # fallback type if pgvector missing
    # 儲存嵌入模型資訊
